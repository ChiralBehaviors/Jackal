...
public class HostNameTest {
    ...
    public void serializeProducesTheExpectedBytes() throws IOException {
        assertThat(serialize(hostName("www.mydomain.com")),
                   is(equalTo(new byte[] { 0x03, 0x77, 0x77, 0x77, 0x08, 0x6D,
                                          0x79, 0x64, 0x6F, 0x6D, 0x61, 0x69,
                                          0x6E, 0x03, 0x63, 0x6F, 0x6D, 0x00 })));
    }
}
