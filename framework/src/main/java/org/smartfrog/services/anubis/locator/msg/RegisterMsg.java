...
public class RegisterMsg implements Serializable {
    ...
    public static RegisterMsg providerNotPresent(ProviderInstance provider) {
        return new RegisterMsg(ProviderNotPresent, provider.copy(),
                               LocalRegister);
    }
    ...
    public String toString() {
        ...
        switch (type) {
            ...
            case RegisterProvider:
                str = "[RegisterProvider, ";
                break;
            case DeregisterProvider:
                str = "[DeregisterProvider, ";
                break;
            case RegisterListener:
                str = "[RegisterListener, ";
                break;
            case DeregisterListener:
                str = "[DeregisterListener, ";
                break;
            ...
            case ProviderValue:
                str = "[ProviderValue, ";
                break;
            case ProviderNotPresent:
                str = "[ProviderNotPresent, ";
                break;
            default:
                str = "[??illegal type??, ";
                break;
