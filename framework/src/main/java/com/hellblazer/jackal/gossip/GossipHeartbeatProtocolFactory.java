 ...
 * 
 */
public class GossipHeartbeatProtocolFactory implements HeartbeatProtocolFactory {
    private final Gossip gossip;

    public GossipHeartbeatProtocolFactory(Gossip gossip) {
        super();
        this.gossip = gossip;
    }
    ...
    public HeartbeatProtocol createProtocol(Heartbeat hb, ViewListener vl,
        ...
        return new GossipHeartbeatProtocol(hb, vl, sharedHeartbeat, gossip);
    }
}
