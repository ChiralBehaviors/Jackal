 ...
 */
@Configuration
public class GraphicControllerConfig {
    private static final Logger    log = LoggerFactory.getLogger(GraphicControllerConfig.class.getCanonicalName());
    ...
    public Controller controller() throws IOException {
        return new GraphicController(partitionIdentity,
