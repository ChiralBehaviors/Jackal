...
public class MessageNioHandler implements SendingListener, IOConnection,
    ...
    */
    ...
    public void deliverObject(ByteBuffer fullRxBuffer) {
        ...
        try {
            ...
            if (log.isLoggable(Level.SEVERE)) {
                log.severe(me
                           + "non blocking connection transport encountered security violation unmarshalling message - ignoring the message "); // + this.getSender() );
            }
            return;
    ...
    public int writeData() {
        ...
        int returnedInt = SENDING_REFUSED;
        long dataLeftToSend = (dataToWrite[0].remaining() + dataToWrite[1].remaining());
