...
public class ConnectionSet implements ViewListener, HeartbeatReceiver {
    ...
    public synchronized boolean receiveHeartbeat(Heartbeat hb) {
        ...
        if (con == null) {
            ...
            HeartbeatProtocol hbp = heartbeatProtocolFactory.createProtocol(
                                                                            hb,
                                                                            this,
                                                                            heartbeat);
    ...
    public void deploy() throws IOException {
         ...
         */
        heartbeat = heartbeatProtocolFactory.createMsg(
                                                       identity,
                                                       connectionServer.getAddress());
    ...
    public synchronized String toString() {
        ...
        str.append("\n").append(identity).append(" ConnectionSet view: ").append(
                                                                                 super.toString());
        str.append("\n==================================================");
        for (Connection con : connections.values()) {
